...
<div class="bg-image bg-image-bottom"
    ...
    <div class="bg-black-op-75 py-30">
        <div class="content content-full text-center">
            <!-- Avatar -->
            <div class="mb-15">
                <a class="img-link" href="/{{auth('seller')->user()->banner}}">
            ...
            <!-- Actions -->
            <a href="{{url('/seller/dashboard')}}" class="btn btn-rounded btn-hero btn-sm btn-alt-secondary mb-5">
    ...
    <div class="content">
        ...
        <div class="block">
            ...
            <div class="block-content">
                <form role="form" action="{{route('seller.profile_update')}}" method="post"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control" id="example-textarea-input" name="address" rows="6" placeholder="Enter Address.." value="{{auth('seller')->user()->address}}">{{auth('seller')->user()->address}}</textarea>
                        </div>
                        <div class="col-12">
