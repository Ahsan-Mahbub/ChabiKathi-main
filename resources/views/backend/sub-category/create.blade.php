...
<div class="container">
    <div class="block">
        <div class="block-header block-header-default">
            <h3 class="block-title text-center"> Add Sub-Category</h3>
                    ...
                    @csrf
                        <div class="form-group">
                            <div class="form-material">
                                <input type="text" class="form-control" id="sub_cat_name" name="sub_category_name" placeholder="Enter Sub Category Name.." required="">
                                <label for="sub_cat_name">Sub Category Name <span class="text-danger">*</span></label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-material">
                                <input type="text" class="form-control" id="slug" name="slug" placeholder="Enter Sub Category Slug.." required="">
