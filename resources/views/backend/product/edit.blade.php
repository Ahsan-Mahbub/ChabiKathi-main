            ...
            <div class="row justify-content-center py-20">
                <div class="col-xl-12">
                    ...
                    @csrf
                            ...
                            <div class="form-material">
                                <select class="form-control" id="example-select" name="cat_id">
                                    ...
                                    @foreach($category as $value)
                                        <option value="{{$value->id}}" {{ $product->cat_id == $value->id ? 'selected' : ''}}>{{$value->category_name}} </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group">
                            <div class="form-material">
                                <select class="form-control" id="example-select" name="size_id">
                                    ...
                                    @foreach($category as $value)
                                        <option value="{{$value->id}}" {{ $product->size_id == $value->id ? 'selected' : ''}}>{{$value->size_name}} </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group">
                            <div class="form-material">
                                <select class="form-control" id="example-select" name="weight_id">
                                    ...
                                    @foreach($category as $value)
                                        <option value="{{$value->id}}" {{ $product->weight_id == $value->id ? 'selected' : ''}}>{{$value->weight_name}} </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group">
                            <div class="form-material">
                                <div class="custom-control custom-radio custom-control-inline mb-5">
                                    ...
                                    @foreach($category as $value)
                                        <div class="col-md-12">
                                            <input class="custom-control-input" type="radio" name="color_id" id="{{$value->color_code}}" value="{{$value->id}}" {{ $product->color_id == $value->id ? 'checked' : ''}}>
                        ...
                        <div class="form-group">
                            <div class="form-material">
                                <input type="number" class="form-control" id="cat_priority" value="{{$product->price}}" name="price" placeholder="Enter Product Price.." required="">
                                <label for="cat_priority">Product Price <span class="text-danger">*</span> </label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-material">
                                <input type="number" class="form-control" id="Discount" value="{{$product->discount}}" name="discount" placeholder="Enter Discount Price..">
                                <label for="Discount">Discount Price</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-material">
                                <input type="number" class="form-control" id="quantity" value="{{$product->quantity}}" name="quantity" placeholder="Enter Quantity..">
                        ...
                        <div class="form-group">
                            <div class="form-material">
                                <input type="text" class="form-control" id="shop" value="{{$product->shop}}" name="shop" placeholder="Enter Shop Name..">
                                <label for="shop">Shop Name</label>
                            </div>
                        </div>

                        <label>Main Image <span class="text-danger">*</span></label>
                        <input type='file' name="product_img" value="{{$product->product_img}}" required="" onchange="readURL(this);" />
