...
<div class="block">
    <div class="block-header block-header-default">
        <h3 class="block-title text-center"><b>Sub Sub Categories Table</b></h3>
        <a href="{{route('sub-sub-category.create')}}" class="btn btn-success mr-5 mb-5">
            <i class="fa fa-plus mr-5"></i>Add Sub Sub Category
        </a>
    </div>
            ...
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                           <a class="btn btn-sm btn-secondary m-5" href="{{route('sub-sub-category.edit',$value->id)}}">
                                <i class="fa fa-pencil text-primary mr-5"></i> Edit
                            </a>
                            <a class="btn btn-sm btn-secondary m-5 delete-confirm" href="{{route('sub-sub-category.delete',$value->id)}}" data="{{$value->id}}" id="delete" type="button">
...
@section('script')
                ...
                if (value) {
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            window.location.href = "/kathi/cbmin/sub-sub-category/list" ;
                        },
                    });
                }
            });
    ...
    <script type="text/javascript">
        ...
        $.ajax({
            url: '/kathi/cbmin/sub-sub-category/status/'+id+'/'+status,
            type: 'get',
            dataType: 'json',
            success: function(response) {
