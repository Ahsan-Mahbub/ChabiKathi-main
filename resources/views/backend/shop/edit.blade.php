...
<div class="container">
    <div class="block">
        <div class="block-header block-header-default">
            <h3 class="block-title text-center"> Update Shop</h3>
        ...
        <div class="block-content">
            <div class="row justify-content-center py-20">
                <div class="col-xl-6">
                    <form role="form" action="{{route('shop.update',$shop->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                        <div class="form-group">
                            <div class="form-material">
                                <input type="text" class="form-control" value="{{$shop->shop_name}}" id="sub_cat_name" name="shop_name" placeholder="Enter Shop Name.." required="">
                                <label for="sub_cat_name">Shop Name <span class="text-danger">*</span></label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-material">
                                <input type="text" class="form-control" value="{{$shop->slug}}" id="slug" name="slug" placeholder="Enter Shop Slug.." required="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-material">
                                <select class="js-select2 form-control js-select2-enabled select2-hidden-accessible" id="val-select22" name="category_id" style="width: 100%;" data-placeholder="Choose one.." data-select2-id="val-select22" tabindex="-1" aria-hidden="true">
                                    ...
                                    <option value="{{$value->id}}" {{ $shop->brand_id == $value->id ? 'selected' : ''}}>{{$value->brand_name}} </option>
                                    @endforeach
                                </select>
